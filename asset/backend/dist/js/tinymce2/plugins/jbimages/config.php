...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = "https://".$_SERVER['SERVER_NAME'].'/public/image/tinymce'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/public/image/tinymce';// $config['img_path']; // Physical path. [Usually works fine like this]
