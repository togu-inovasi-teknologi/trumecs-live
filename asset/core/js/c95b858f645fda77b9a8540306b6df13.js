...
//# sourceMappingURL=jquery.number.min.js.map$(document).ready(function () {
  console.log("cari.js loaded - Filter search initialized");
    ...
    $("select[name=sub_kategori]").load(
      ...
      function () {
        if (selectedValue) {
          ...
          $(this).val(optionExists ? selectedValue : "");
        }
      }
    );
  }
  ...
  $("select[name=komponen]").load(
    ...
    function () {
      console.log("Komponen dropdown loaded");
      ...
      // Ambil dari data attributes yang benar
      ...
      console.log("Selected values from data attributes:", {
        component: seletedcomponent,
        brand: seletedbrand,
        sub: seletedsub,
        type: seletedtype,
        quality: seletedquality,
      });

      // Juga coba ambil dari attributes lama untuk kompatibilitas
      if (!seletedbrand) seletedbrand = formsearch.attr("seletedbrand") || "";
      if (!seletedcomponent)
        seletedcomponent = formsearch.attr("seletedcomponent") || "";
  ...
  // Load default merek jika tidak ada komponen terpilih
  ...
  $("select[name=komponen]").change(function () {
    ...
    var form = $(".form-filter-search");

    loadSubKategori(componentId, form.attr("data-selected-sub"));
    loadMerek(componentId, form.attr("data-selected-brand"));
    loadQuality(componentId, form.attr("data-selected-quality"));
  });
  ...
  console.log("Filter search script ready");
});
var base_url = $("body").attr("baseurl");
