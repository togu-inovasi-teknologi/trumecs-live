...
$(document).ready(function () {
  ...
  $(document).on("click", ".edit-categori", function () {
    ...
    // Destroy select2 yang mungkin sudah ada
    $(
      ".select2-grade-edit, .select2-brand-edit, .select2-attribute-edit"
    ).select2("destroy");
    ...
    loadSelectDataForEdit()
      ...
      .then(function () {
        console.log("✓ Category data loaded, showing modal in 100ms...");

        // Tambahkan delay kecil sebelum show modal
      ...
      .then(function () {
        ...
        try {
          // Bootstrap 5
          var modalElement = document.getElementById("edit-categori");
          ...
          console.log("Modal shown with Bootstrap 4 API");
        }
      })
