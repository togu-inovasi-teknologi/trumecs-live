...
$(document).ready(function () {
  var table = $("#gradeTable").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "<?php echo site_url('grade/ajax_list') ?>",
      type: "POST",
    },
    columns: [
  ...
  $("#addForm").on("submit", function (e) {
    ...
    $.ajax({
      url: "<?php echo site_url('grade/ajax_add') ?>",
      type: "POST",
      data: $(this).serialize(),
      dataType: "json",
  ...
  $("#editForm").on("submit", function (e) {
    ...
    $.ajax({
      url: "<?php echo site_url('grade/ajax_update') ?>",
      type: "POST",
      data: $(this).serialize(),
      dataType: "json",
      success: function (response) {
  ...
  $("#gradeTable").on("click", ".delete", function () {
    if (confirm("Are you sure you want to delete this grade?")) {
      ...
      $.ajax({
        url: "<?php echo site_url('grade/ajax_delete') ?>",
        type: "POST",
        data: { id: id },
        dataType: "json",
        success: function (response) {
