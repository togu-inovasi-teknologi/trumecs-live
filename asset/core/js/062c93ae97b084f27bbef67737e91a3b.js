...
$(document).ready(function () {
  ...
  var productId = pathParts[2]; // Ambil dari /product/{id}/...
  // Jika tidak ada di URL, coba dari hidden field
  if (!productId || isNaN(productId)) {
    productId = $("#current_product_id").val();
  }

  console.log(base_url + "product/getsameproduct_ajax/" + productId);
  ...
  function initSameProductTable(productId) {
    $("#sameProductDetailTable").DataTable({
      ...
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            if (type === "sort") {
              return row.price_raw; // Untuk sorting
            }
            return data; // Untuk display
          },
        },
      ],
      ...
      initComplete: function () {
        ...
        $("#sameProductDetailTable_wrapper").css("opacity", 1);
      },
    });
  }
});
