...
console.log($("#edit-categori").css("display"));
console.log($("#edit-categori").hasClass("show"));
console.log($("#edit-categori .modal-dialog").length);
...
$(document).ready(function () {
  ...
  // $("#edit-categori").on("show.bs.modal", function (e) {
  //   // Ambil category ID dari button yang diklik
  //   var button = $(e.relatedTarget); // Button yang trigger modal
  //   var categoryId = button.data("id");

  //   // Inisialisasi Select2 terlebih dahulu
  //   initSelect2Edit();

  //   // Load semua data select2 dan category data
  //   loadSelectDataForEdit().then(function () {
  //     // Setelah select2 options dimuat, load data category
  ...
  $(document).on("click", ".edit-categori", function () {
    ...
    loadSelectDataForEdit()
      ...
      .then(function () {
        ...
        var modalEl = document.getElementById("edit-categori");
        var bsModal = new bootstrap.Modal(modalEl, {
          backdrop: "static",
          keyboard: false,
        });
        bsModal.show();
        var $modal = $("#edit-categori");
        ...
        console.log("Transform:", $modal.css("transform"));
        console.log(
          "Modal dialog z-index:",
          $modal.find(".modal-dialog").css("z-index")
        );
        console.log("Backdrop count:", $(".modal-backdrop").length);
        console.log("Backdrop z-index:", $(".modal-backdrop").css("z-index"));

        // Verifikasi setelah 300ms
        setTimeout(function () {
          console.log("Modal visible?", $("#edit-categori").is(":visible"));
          console.log("Modal display:", $("#edit-categori").css("display"));
          console.log(
            "Modal has show class?",
            $("#edit-categori").hasClass("show")
          );
        }, 300);
      })
