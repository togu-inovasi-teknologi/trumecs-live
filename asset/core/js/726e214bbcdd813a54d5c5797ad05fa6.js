...
//					calculate new width ratio
	...
	if (isMobile==false) {
		...
		$('.img-detail-lg').elevateZoom({
			zoomWindowFadeIn: 400, zoomWindowFadeOut: 400, lensFadeIn: 400, lensFadeOut: 400 
		});
	} else{
		$(".slicksameproduct12").slick({
			arrows: false, 
    ...
    $(document).on('click', '.btn-add-item', function(){
        ...
        html += "<select name=\"id_produk[]\" class=\"js-example-basic-single form-control\" placeholder=\"Nama produk\" >";
        html += "<option value=\"\">-- Pilih Item --</option>";
        html += "</select>";
        html += "</div>";
        html += "<div class=\"col-xs-2\">";
        html += "<input type=\"number\" name=\"qty[]\" class=\"form-control\" value=\"1\" />";
        html += "</div>";
        html += "</div>";
...
$(".changeimagegalery").on("click",function() {
	...
	$(".tochangebyclick").attr("data-zoom-image",$(this).attr("zoom-src-no-crop"));
	$(".zoomWindowContainer div").css("background-image",'url('+$(this).attr("zoom-src-no-crop")+')');
})
...
$(".btn-min").on("click",function() {
    if(parseInt($('input[name="value"]').val()) > parseInt($('input[name="value"]').attr('minimum'))) {
        $('input[name="value"]').val(parseInt($('input[name="value"]').val())-1);
        $('input[name="value"]').data('prev-val', $('input[name="value"]').val());
        if($('input[name="value"]').val() >= $('input[name="value"]').data('min-volume')){
...
$(document).on("click",".btn-plus",function() {
    if(parseInt($('input[name="value"]').val()) < parseInt($('input[name="value"]').attr('maximum'))) {
        $('input[name="value"]').val(parseInt($('input[name="value"]').val())+1);
        $('input[name="value"]').data('prev-val', $('input[name="value"]').val());
        if($('input[name="value"]').val() >= $('input[name="value"]').data('min-volume')){
            $('.ticket-volume').addClass('ticket-active');
...
$(document).on("change","input[name='value']",function() {
    if((parseInt($('input[name="value"]').attr('minimum')) < parseInt($('input[name="value"]').val())) && (parseInt($('input[name="value"]').val()) < parseInt($('input[name="value"]').attr('maximum')))) {
        $('input[name="value"]').data('prev-val', $('input[name="value"]').val());
        if($('input[name="value"]').val() >= $('input[name="value"]').data('min-volume')){
            $('.ticket-volume').addClass('ticket-active');
        } else {
...
$(".btn-volume").on("click",function() {
    $('input[name="value"]').val(parseInt($('input[name="value"]').val())>=4?$('input[name="value"]').val():4);
    count_total();
});
...
function count_total() {
    cbd_disc = $('.cbd-button').length > 0 ? ($('.cbd-button').hasClass('active')? parseInt($('.cbd-button').data('cbd-price')):0):0;
    volume_disc = $('input[name="value"]').val() >= parseInt($('input[name="value"]').data('min-volume'))? $('input[name="value"]').data('volume-price'):0;
    referral_disc = $('.ticket-referral').length > 0 ? ($('.ticket-referral').hasClass('ticket-active')? parseInt($('.ticket-referral').data('referral-price')) :0) : 0;
    price_list = parseInt($('.price-list').data('price'));
    base_price = parseInt($('.price-promo').data('price')) > 0 ? parseInt($('.price-promo').data('price')) : price_list ;
    ...
    $('.total-label').text((disc_price*parseInt($('input[name="value"]').val())).toLocaleString('id-ID'));
    /* } else {
