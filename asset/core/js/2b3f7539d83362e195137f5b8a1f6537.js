$(document).ready(function () {
  ...
  $("select[name=jenisproduct]").change(function (argument) {
    ...
    if (value == "Sparepart" || value == "Aksesoris") {
      ...
      $(".attr-unit").slideDown(200);
      $(".attr-unit-fisik").slideUp(200);
    } else if (value == "Unit") {
      $("select[name='brand_unit']").prop("disabled", false);
      $("select[name='type']").prop("disabled", false);
      $(".attr-unit").slideUp(200);
      $(".attr-unit-fisik").slideDown(200);
    } else {
  ...
  if (initialValue == "Sparepart" || initialValue == "Aksesoris") {
    $("select[name='brand_unit']").prop("disabled", false);
    $("select[name='type']").prop("disabled", false);
    $(".attr-unit").show();
    $(".attr-unit-fisik").hide();
  } else if (initialValue == "Unit") {
    $("select[name='brand_unit']").prop("disabled", false);
    $("select[name='type']").prop("disabled", false);
    $(".attr-unit").hide();
