...
$(document).ready(function () {
  $("#sameProductDetailTable").DataTable({
    ...
    ajax: {
      ...
      type: "POST",
      data: function (d) {
        // Tambahkan parameter custom yang diperlukan
        d.product_id = $("#current_product_id").val();
        d.brand_id = $("#current_brand_id").val();
        d.search_terms = $("#search_terms").val();
      },
    },
    columns: [
      {
        data: "tittle", // Ganti dari data: 0 ke 'tittle'
        name: "product.tittle",
        orderable: true,
      },
      {
        data: "brand", // Ganti dari data: 1 ke 'brand'
        name: "categori.name",
        orderable: true,
        className: "text-center",
      },
      {
        data: "grade", // Ganti dari data: 2 ke 'grade'
        name: "grade.grade",
        orderable: true,
        className: "text-center",
      },
      {
        data: "price", // Ganti dari data: 3 ke 'price'
        name: "product.price",
        orderable: true,
    ...
    language: {
      ...
      zeroRecords: "Tidak ditemukan produk serupa",
