...
$("select[name=category]").change(function (argument) {
  var value = $(this).val();
  $("select[name=subCategory]").load(
    ...
    function () {
      if (
        $(
          "select[name=subCategory] option[value='" +
...
$(document).ready(function () {
  setTimeout(function () {
    ...
    if (seletedcomponent != "") {
      $("select[name=category]").val(seletedcomponent);
      $("select[name=subCategory]").load(
    ...
    setTimeout(function () {
      ...
      if (seletedsub != "") {
        $("select[name=subCategory]").val(seletedsub);
      }
    }, 2000);
  }, 2000);
