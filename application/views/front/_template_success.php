...
<head>
    ...
    <?php if ($this->uri->segment(1) == 'cart' || $this->uri->segment(2) == 'signup' || $this->uri->segment(2) == 'buy' || $this->uri->segment(2) == 'contact' || $this->uri->segment(2) == 'tender' || $this->uri->segment(1) == 'agent' || $this->uri->segment(1) == 'principal' || $this->uri->segment(1) == 'bulk' || empty($this->uri->segments)) : ?>
...
<body onunload="testUnload()" url="<?php echo "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>"
    baseurl="<?php echo base_url() ?>">
    <!-- Google Tag Manager (noscript) -->
    <!-- <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TVC4G9C" height="0" width="0"
    ...
    <section style="margin-top:0px;">
        ...
        <div class=" p-y-1" style="background:#fff;">
            <?php } else if ($this->uri->segment(2) == 'homeproduct') { ?>
            <div class=" p-y-1" style="background:#fff;">
                <?php } else { ?>
                <div class="container p-y-1" style="background:#fff;">
                    <?php } ?>
    ...
    <div class="modal fade modalproccessshow" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false"
        aria-hidden="false">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="row">
                    <div class=" p-a-1 m-x-1 text-center">
                        <span class="modal-text">Sedang Proses</span><br><img width="70px"
                            src="<?php echo base_url() ?>public/image/252.gif">
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
