...
<div id="menu_area" class="menu-area pull-left p-y-0" style="min-width:100px;">
                                ...
                                <?php foreach ($kategori as $item) : ?>
                                    <li class="menu-item menu-1">
                                        ...
                                        <div class="mega-submenu">
                                            <h2 style="position: sticky;position: -webkit-sticky;top:0;z-index: 2;background-color:#fff"><img src="<?php echo base_url() ?>public/icon/category/icon-<?php echo $item['url']; ?>.svg" alt="Icon <?php echo $item['name'] ?>" /> <?php echo $item['name'] ?></h2>
