    ...
    <div class="container-fluid" style="max-width:1500px;">
        <div class="row p-x-1 m-a-0 p-a-0">
            <div class="col-lg-3" style="color: #fff;">
                ...
                <p class="fbold m-t-2 f18"><?php echo $this->lang->line('ikuti_kami', FALSE) ?></p>
                <br>
            ...
            <div class="col-lg-3 m-t-2" style="color: #fff;">
                <p class="fbold f18"><?php echo $this->lang->line('hubungi_kami', FALSE) ?></p>
                <br>
                <div class="row m-a-0 p-a-0">
                    ...
                    <div class="col-xs-10" style="margin-top: 5px;">
                        <a href="https://wa.me/<?php echo platform_contact('whatsapp') ?>" target="_blank" rel="noreferrer">
                            <p class="f14" style="color:#fff;"> <?php echo platform_contact('whatsapp') ?></p>
                        </a>
                    </div>
                </div>
                <div class="row m-t-2 m-a-0 p-a-0">
                    ...
                    <div class="col-xs-10" style="margin-top: 5px;">
                        <a href="https://mail.google.com/mail/u/0/?view=cm&tf=1&fs=1&to=<?php echo platform_contact('email') ?>" target="_blank" rel="noreferrer">
                            <p class="f14" style="color:#fff;"><?php echo platform_contact('email') ?></p>
                        </a>
                    </div>
                </div>
                <div class="row m-t-2 m-a-0 p-a-0">
                    ...
                    <div class="col-xs-10" style="margin-top: 5px;">
                        <a href="https://goo.gl/maps/a4emSqqX4qWaQikG7" target="_blank" rel="noreferrer">
                            <p class="f14" style="color:#fff;"><?php echo platform_contact('address') ?></p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row m-t-2 m-a-0 p-a-0">
                    ...
                    <div class="col-lg-6 text-right">
                        <form action="_footerdesktop_new.php" method="POST">
                            ...
                            <p class="fbold f18 m-b-2" style="color:#fff;"><?php echo $this->lang->line('info_trumecs', FALSE) ?></p>
