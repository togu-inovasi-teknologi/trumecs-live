...
|
*/
// $config['base_url'] = 'https://' . $_SERVER['HTTP_HOST']; //'https://www.trumecs.com';
$config['base_url'] = 'http://' . $_SERVER['HTTP_HOST']; //'https://www.trumecs.com';
...
$config['language']    = $obj_language['language'];
...
|
*/
$config['encryption_key'] = 'trumecsbytrisindo';
