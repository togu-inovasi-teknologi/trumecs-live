<div class="product">
	...
	<div class="row">
		...
		<input type="hidden" name="status" value="<?php echo $this->input->get('status') ?>" />
			<div class="col-xs-12 table-responsive">
			<table id="table-withdraw" class="table table-striped table-bordered table-hover" cellspacing="2" width="100%">
			  <thead>
			    <tr>
			      <th>ID<br><small>Pemesan</small></th>
			      <th>Tanggal<br><small>Tanggal Tranfer</small></th>
			      <th>Nama Bank<br><small>No Rekening</small></th>
			      <th>Status</th>
			    </tr>
			  </thead>
			  <tbody>
			    ...
			    <tr>
			      <td><a href="<?php echo base_url() ?>backendconfirm/detail_withdraw/<?php echo $key["id"] ?>" class="fbold f14 forange"><?php echo $key["id"] ?></a><br>
			      	<small><a href="<?php echo base_url() ?>backendmember/detail/<?php echo $key["user_id"]?>" class="fblack">lihat pemesan</a></small>
			      </td>
			      <td>
			      	<span  class="fbold f14 black"><?php echo $this->date->format_panjang_waktu(date('Y-m-d H:i:s'),$key["created_at"]) ?></span><br>
			      </td>
			      <td>
			      	<span  class="fbold f14 black"><?php echo $key["bank_name"] ?></span><br>
			      	<small class="fbold f12 black"><?php echo $key["bank_holder"] ?></small><br/>
			      	<small class="fbold f12 black"><?php echo $key["bank_account"] ?></small>
			      </td>
			      <td>
