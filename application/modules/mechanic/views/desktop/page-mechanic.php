<div class="d-flex flex-column gap-3">
    <section id="banner" class="bg-white">
        <div class="container-fluid gradient-black-white d-flex justify-content-between align-items-center w-100 p-a-0" style="background-image: url('/public/banner/banner-mechanic.png');
background-position: center;height:250px;">
            <div class="d-flex flex-column gap-2 p-l-3 col-md-6">
            ...
            <!--<img src=" /public/banner/banner-mechanic.png" alt="mechanic.png" height="250" class="mr-0">-->
        </div>
    </section>

    <section id="tentang" class="bg-white">
        <div class="container d-flex gap-2">
            <div class="col-lg-4 bg-grey p-a-1">
                <h5 class="fbold">MECHANIC</h5>
                <p>Find the best mechanics! Trusted, experienced professionals ready to fix your toughest issues.</p>
            </div>
            <div class="col-lg-4 bg-grey p-a-1">
                <h5 class="fbold">DRIVER & OPERATOR</h5>
                <p>Elevate your projects with top truck drivers & operators! Work with the industry's most experienced.</p>
            </div>
            <div class="col-lg-4 bg-grey p-a-1">
                <h5 class="fbold">DRAFTER</h5>
                <p>Top drafters await! Engage the most skilled and experienced pros for precise designs.</p>
            </div>
        </div>
    </section>
    <section id="mechanic" class="bg-white m-b-2">
        <div class="container d-flex flex-column gap-3">
            <div class="col-lg-12 d-flex justify-content-between align-items-center p-a-0">
                <h4 class="fbold m-a-0">Browse Mechanics</h4>
                <!--<div class="d-flex gap-2 align-items-center">
                    <button class="btn btnnew radius-sm" data-toggle="modal" type="button" data-target="#filter-mechanic"><i class="fa fa-filter"></i> Filter</button>
            ...
            <!-- <div class="col-lg-12 p-a-0">
                <?php foreach ($kategori as $value) : ?>
                    ...
                    <div class="d-flex gap-2">
                        <?php foreach ($subKategori as $subValue) : ?>
                            <p><?= $subValue['name'] ?></p>
                        <?php endforeach; ?>
                    </div>
                <?php endforeach; ?>
            </div> -->
            <div class="col-lg-12 d-flex flex-column gap-3 p-a-0">
                <div class="row">

                    <?php foreach ($mechanic as $dataMechanic) : ?>
                        <div class="col-lg-6">
                            <div class="card bg-card-mechanic radius-sm p-a-1 d-flex gap-2">
                                ...
                                <div class="d-flex flex-column gap-1 w-100">
                                    ...
                                    $name = implode(' ', $names);
                                    ?>
                                    <h6 class="fbold"><?= $name ?>, <?= getAge($dataMechanic['made']) ?> </h6>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="fbold"><i class="fa fa-id-badge forange"></i> <?= $dataMechanic['grade'] ?></h6>
                                        <h6 class="fbold"><i class="fa fa-map-marker forange"></i> <?= str_replace(["KABUPATEN ", "KOTA "], "", $dataMechanic['nama_domisili']) ?></h6>
                                    </div>
                                    <div class="d-flex gap-2 align-items-center">
                                    ...
                                    <a href="<?= base_url() ?>mechanic/detail/<?= $dataMechanic['id'] ?>" class="btn btnnew radius-sm text-center f12" style="width:fit-content">View More</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
