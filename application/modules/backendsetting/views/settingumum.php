							...
							<tr>
								...
								<td>
									<div class="d-flex gap-2">
										<a class="btn btn-orange" href="<?php echo base_url() ?>backendsetting/uploadAdminToSheetFromDB"><i class="bi bi-upload"></i> DB To Sheet</a>
										<a class="btn btn-orange" href="<?php echo base_url() ?>backendsetting/syncDatabaseAdmin"><i class="bi bi-arrow-repeat"></i> Sync Database</a>
										<a class="btn btn-orange" href="<?php echo base_url() ?>backendsetting/importAdminFromSheet"><i class="bi bi-download"></i> Sheet To DB</a>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div class="d-flex gap-2">
										...
										<a class="btn btn-orange" href="<?php echo base_url() ?>backendsetting/syncDatabaseGalery"><i class="bi bi-arrow-repeat"></i> Sync Database</a>
										<a class="btn btn-orange" href="<?php echo base_url() ?>backendsetting/importGaleryFromSheet"><i class="bi bi-download"></i> Sheet To DB</a>
									</div>
								</td>
							</tr>
						</tbody>
