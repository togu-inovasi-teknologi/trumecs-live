			...
			<table id="table-promo" class="table table-striped table-bordered table-hover" cellspacing="2" width="100%">
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td>
			      	<a href="<?php echo base_url() ?>backendpromo/form?id=<?php echo $key["id"] ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
			      </td>
			      <td>
			      	<a href="<?php echo base_url() ?>backendpromo/hapuspromo?id=<?php echo $key["id"] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
			      </td>
			    </tr>
			    <?php endforeach ?>
				<?php else: ?>
