            ...
            <div class="product row"
                ...
                <div class="col-md-12 p-a-3">
                    ...
                    <form class="m-y-2" method="post" action="<?php echo base_url('principal/save'); ?>">
                        ...
                        <div class="form-group row">
                            <label
                                class="control-label col-xs-12"><strong><?php echo $this->lang->line('label_email') ?></strong></label>
                            <div class="col-xs-12">
                                <input class="form-control" name="email"
                                    placeholder="<?php echo $this->lang->line('placeholder_input_email') ?>"
                                    <?php echo $user_data['email'] ?> required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" name="company"
                                    ...
                                    <?php echo $user_data['company'] ?> required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label
                                class="control-label col-xs-12"><strong><?php echo $this->lang->line('label_jenis_produk') ?></strong></label>
                            <div class="col-xs-12">
                                <input class="form-control" name="product"
                                    placeholder="<?php echo $this->lang->line('placeholder_input_jenis_produk') ?>"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label
                                class="control-label col-xs-12"><strong><?php echo $this->lang->line('label_brand') ?></strong></label>
                            <div class="col-xs-12">
                                <input class="form-control" name="brand"
                                    placeholder="<?php echo $this->lang->line('placeholder_input_brand') ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label
                                class="control-label col-xs-12"><strong><?php echo $this->lang->line('label_negara_asal') ?></strong></label>
                            <div class="col-xs-12">
                                <input class="form-control" name="country"
                                    placeholder="<?php echo $this->lang->line('placeholder_input_negara_asal') ?>"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label
                                class="control-label col-xs-12"><strong><?php echo $this->lang->line('label_penjelasan_produk') ?></strong></label>
                            <div class="col-xs-12">
                                <textarea class="form-control" name="additional_info"
                                    placeholder="<?php echo $this->lang->line('placeholder_input_penjelasan_produk') ?>"
                                    required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 text-center">
                                <button
                                    class="btn col-lg-12 btn-orange"><?php echo $this->lang->line('tombol_kirim') ?></button>
                            </div>
                        </div>
                    </form>
                </div>
