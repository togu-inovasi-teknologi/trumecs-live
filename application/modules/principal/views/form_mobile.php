            ...
            <div class="product row">
                <div class="col-md-12">
                    ...
                    <form class="m-y-2" method="post" action="<?php echo base_url('principal/save'); ?>">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-xs-12"><strong><?php echo $this->lang->line('brand') ?></strong></label>
                            <div class="col-xs-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12">
                                <textarea class="form-control" name="additional_info" placeholder="<?php echo $this->lang->line('placeholder_penjelasan_produk') ?>" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xs-12">
