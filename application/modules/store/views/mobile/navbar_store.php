...
<nav class="navbar navbar-fixed-top" role="navigation" style="background-color:<?= $style[0]->color_nav == null ? '#000' : $style[0]->color_nav  ?>">
    <div class="row">
        <div id="logo" class="d-flex-ai-center">
            <div class="col-xs-1 p-x-0">
                <span class="btn p-x-1 p-y-0 f20 navbar-toggle offcanvas-toggle offcanvas-toggle-close" data-toggle="offcanvas" data-target="#js-mobile-offcanvas"><i class="fa fa-bars" style="color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>;"></i></span>
            </div>
            ...
            <div class="col-xs-3 text-right p-x-0">
                <a style="color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>; margin-right:10px;" class="f20" onclick="show()"><i class="fa fa-search "></i></a>
                <a class="f20 m-r-1" style="color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>;"><i class="fa fa-bell-o"></i></a>
            </div>
        </div>
...
<nav class="navbar navbar-fixed-bottom p-a-0" role="navigation" style="border-top:1px solid<?= $style[0]->color_nav == null ? '#000' : $style[0]->color_nav  ?>;background-color: <?= $style[0]->color_nav == null ? '#000' : $style[0]->color_nav  ?>">

    <div class="row p-x-1" style="padding-top: 5px;background-color:<?= $style[0]->color_nav == null ? '#000' : $style[0]->color_nav  ?>">
        <div class="col-lg-2--4 text-center p-x-0">
            <a href="<?php echo site_url() ?>" style="line-height:1;color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>">
                <i class=" fa fa-home f22"></i></br>
                <h6 class="f10">Beranda</h6>
            </a>
        </div>
        <div class="col-lg-2--4 text-center p-x-0">
            <a href="<?php echo site_url('cart'); ?>" style="line-height:1;color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>">
                <i class="fa fa-shopping-cart f22"></i></br>
                <h6 class="f10">Keranjang</h6>
            </a>
        </div>
        <div class="col-lg-2--4 text-center p-x-0">
            <a href="https://wa.me/+6285176912338?text=<?php echo urlencode("Hi Trumecs, saya ingin mengetahui tentang produk yang dijual") ?>" style="line-height:1;color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>">
                <i class="fa fa-commenting f22"></i></br>
                <h6 class="f10">Pesan</h6>
            </a>
        </div>
        <div class="col-lg-2--4 text-center p-x-0">
            <a href="<?php echo site_url('promo'); ?>" style="line-height:1;color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>">
                <i class="fa fa-tags f22"></i></br>
                <h6 class="f10">Promo</h6>
            </a>
        </div>
        <div class="col-lg-2--4 text-center p-x-0">
            <a href="<?php echo site_url('member'); ?>" style="line-height:1; color:<?= $style[0]->color_nav_text == null ? '#fff' : $style[0]->color_nav_text ?>">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item d-flex-sb align-items-center" data-toggle="collapse" data-target="#bahasa" aria-expanded="false" aria-controls="bahasa"><?php echo $this->lang->line('bahasa', FALSE); ?>:
                <div class="d-flex-ai-center gap-1">
                    <img class="icon-w-20" src="<?php echo base_url() ?>public/icon/flag/<?php echo get_cookie('language'); ?>.png" />
            ...
            <div class="collapse" id="bahasa" style="background-color:#fff;">
                <a href="<?php echo 'http://192.168.1.30:8080' . $_SERVER['REQUEST_URI']; ?>">
                    <li class="list-group-item list-group-item-warning f14 d-flex-ai-center gap-1" data-toggle="collapse"> <img class="icon-w-20" src="<?php echo base_url() ?>public/icon/flag/id.png" /> Indonesia
                    </li>
                </a>
                <a href="<?php echo 'http://en.trumecs-dev.com:8080' . $_SERVER['REQUEST_URI']; ?>">
                    <li class="list-group-item list-group-item-warning f14  d-flex-ai-center gap-1" data-toggle="collapse"><img class="icon-w-20" src="<?php echo base_url() ?>public/icon/flag/en.png" /> English
                    </li>
                </a>
                <a href="<?php echo 'http://cn.trumecs-dev.com:8080' . $_SERVER['REQUEST_URI']; ?>">
                    <li class="list-group-item list-group-item-warning f14  d-flex-ai-center gap-1" data-toggle="collapse"><img class="icon-w-20" src="<?php echo base_url() ?>public/icon/flag/cn.png" /> Chinnese</li>
                </a>
            </div>
