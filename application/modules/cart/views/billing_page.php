											...
											<table class="table text-left">
												<tbody class="table-chart-detail ">
													...
													<tr>
														...
														<!-- <td><?php //echo  ($datashipping["shipping_description"]=="pickup") ? "FREE" : "Rp.". number_format($datashipping["shipping_cost"]); ?></td> -->
													...
													<tr><td colspan="2"><small><?php //echo strtoupper("Total harga sudah termasuk PPN dari setiap produk yang memiliki PPN") ?></small></td></tr>
												</tbody>
											</table>
											<hr class="m-a-0">
											<table class="table text-left">
