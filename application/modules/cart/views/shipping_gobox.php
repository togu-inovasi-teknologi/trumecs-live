...
<div class="shipping_gojek <?php echo ($this->agent->is_mobile()) ? "row" : "" ; ?>">
	<div class="col-md-12 text-center">
		<strong class="f22">Pengiriman Go-Box</strong>
		<hr>
	</div>
	<div class="col-md-6">
		<img src="<?php echo base_url() ?>public/image/benner-trumecs-and-gobox.png" class="img-fluid">
	</div>
	<div class="col-md-6 control-group " id="accordion">
		<strong class="f16 fbold">Pilih Alamat</strong>
		<?php foreach ($address_shipping as $key ): ?>
			<?php if ($key["tipe"]=="gojek"  or $key["tipe"]=="gobox"): ?>
			<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="heading<?php echo $key["id"] ?>">
						<span class="panel-title keyid<?php echo $key["id"] ?>">
							<a  aria-controls="adddess<?php echo $key["id"] ?>" class="label label-gobox " data-toggle="collapse" data-parent="#accordion" href="#adddess<?php echo $key["id"] ?>" aria-expanded="false" >
				...
				<div id="adddess<?php echo $key["id"] ?>" alamat="<?php echo  $key["address"] ?>" detail='<?php echo $key['detail_address'] ?>'  showin="#result_service<?php echo $key["id"] ?>" jarak="<?php echo $key["jarak"] ?>" kurir="2"  class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading<?php echo $key["id"] ?>">
		...
		<div class="panel panel-default">
			<div class="panel-heading" role="tab" id="heading<?php echo $key["id"] ?>">
				<span class="panel-title">
					<a class="label label-gobox" data-toggle="collapse" data-parent="#accordion" href="#addnew" aria-expanded="true" >
						+ Alamat Lain
					</a>
				</span>
			</div>
			<div id="addnew" class="panel-collapse collapse" role="tabpanel" >
				...
				<input class="" type="hidden" value="2" id="ojeknya">
				<div id="map"></div>
