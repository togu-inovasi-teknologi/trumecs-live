                    ...
                    <!-- <div class="video-container">
                        <div class="video-placeholder">
                            ...
                            <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                                ...
                                class="video-thumbnail img-fluid rounded-3">
                        </div>
                    ...
                    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?php echo base_url() ?>timthumb?h=400&src=<?php base_url(); ?>/public/banner/home-mobile/1.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo base_url() ?>timthumb?h=400&src=<?php base_url(); ?>/public/banner/home-mobile/2.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo base_url() ?>timthumb?h=400&src=<?php base_url(); ?>/public/banner/home-mobile/3.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo base_url() ?>timthumb?h=400&src=<?php base_url(); ?>/public/banner/home-mobile/3.png" class="d-block w-100" alt="...">
                            </div>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        /* Untuk mobile, gunakan click bukan hover */
        .step-item {
            cursor: pointer;
        }
    }
