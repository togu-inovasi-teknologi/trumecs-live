...
<section class="banner-ads m-b-1">
    <div class="container">
        <a href="https://www.trumecs.com" target="_blank" alt="Link ke trumecs">
            <div class="row">
                <div class="col-lg banner-front radius-lg p-a-3" style="background-color: #ffffff;">
                    ...
                    <img src="/public/banner/banner-nataru.png" alt="Nataru 2025 to 2026" width="100%" class="img-fluid" style="top:0; right:0;">
                </div>
            </div>
        </a>
    </div>
