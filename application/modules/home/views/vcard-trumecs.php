            ...
            <div class="body">
                <div class="vcard">
                    ...
                    <div class="vcard-body">
                        <a href="https://api.whatsapp.com/send?phone=6285176912338">
                            <div class="vcard-row">
                                <div class="vcard-icon" style="padding-top:7px;"><img src="<?php echo base_url('public/vcard/whatsapp.png'); ?>" /></div>
                                <div class="vcard-info"><p><?php echo $vcard->row()->phone ?></p></div>
                            </div>
                        </a>
                        <a href="mailto:<?php echo $vcard->row()->email ?>">
                        <div class="vcard-row">
                        ...
                        <a href="https://www.linkedin.com/company/trumecs">
                        <div class="vcard-row">
                            <div class="vcard-icon" style="padding-top:10px;"><img src="<?php echo base_url('public/vcard/linkedin.png'); ?>" /></div>
                            <div class="vcard-info"><p>Trumecs</p></div>
                        </div>
                        </a>
                        <a href="https://www.instagram.com/trumecs/">
                        <div class="vcard-row">
                            <div class="vcard-icon" style="padding-top:10px;"><img src="<?php echo base_url('public/vcard/instagram.png'); ?>" /></div>
                            <div class="vcard-info"><p>Trumecs</p></div>
                        </div>
                        </a>
                        <a href="https://www.facebook.com/trumecsid/">
                        <div class="vcard-row">
                            <div class="vcard-icon" style="padding-top:10px;"><img src="<?php echo base_url('public/vcard/facebook.png'); ?>" /></div>
                            <div class="vcard-info"><p>Trumecs</p></div>
                        </div>
                        </a>
                    </div>
