        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo base_url() ?>timthumb?h=400&src=<?php base_url(); ?>/public/banner/home-mobile/1.png" class="d-block w-100" alt="banner trumecs.com">
                </div>
                <div class="carousel-item active">
                    <img src="<?php echo base_url() ?>timthumb?h=400&src=<?php base_url(); ?>/public/banner/home-mobile/2.png" class="d-block w-100" alt="banner trumecs.com">
                </div>
            </div>
