<?php 
	...
	$complaint= $detailconfirm["complaintwarranty"];
	$detailmember= $detailconfirm["detailmember"];

 ?>
<div class="detail row">
	<div class="col-md-12">
		<strong class="f22">Detail Klaim Garansi di Id Order #<?php echo ($complaint["idorder"]) ?></strong>
		<hr>
	</div>
	...
	<div class="col-md-6">
		<div class="alert alert-warning">
			<a target="_blank" href="<?php echo base_url() ?>public/image/complaint/warranty/<?php echo ($complaint["pic_evidence"]) ?>">
			<?php 
			...
			<?php if ($ext==".png" or $ext==".jpg" or $ext==".PNG" or $ext==".JPG" or $ext==".jpeg"): ?>
				<img class="img-fluid" src="<?php echo base_url() ?>public/image/complaint/warranty/<?php echo ($complaint["pic_evidence"]) ?>">
			<?php else: ?>
			Liat FILE Konfimasi
			<?php endif ?>
			</a>
	...
	<div class="col-md-6">
		<div class="alert alert-warning">
			...
			<?php foreach ($morefile as $key): ?>
				<?php if ($key!=""): ?>
				<div class="col-md-6">
				<a target="_blank" href="<?php echo base_url() ?>public/image/complaint/warranty/<?php echo $key ?>">
					<img class="img-fluid" src="<?php echo base_url() ?>public/image/complaint/warranty/<?php echo $key ?>">
				</a>
				</div>
				<?php endif ?>
			<?php endforeach ?>
	...
	<div class="col-md-12">
		<div class="alert alert-warning">
			...
			<hr>
			<div class="row">
				<form action="<?php echo base_url() ?>backendcomplaintwarranty/updatecomplain" method="POST">
				<div class="col-md-10">
