...
<div class="product">
	...
	<div class="row">
		...
		<input type="hidden" name="status" value="<?php echo $this->input->get('status') ?>" />
			<table id="table-warranty" class="table table-striped table-bordered table-hover" cellspacing="2" width="100%">
			  <thead>
			    <tr>
			  ...
			  <tbody>
			    ...
			    <tr>
			      <td><a href="<?php echo base_url() ?>backendcomplaintwarranty/detail/<?php echo $key["id"] ?>" class="fbold f14 forange"><?php echo $key["idorder"] ?></a><br>
