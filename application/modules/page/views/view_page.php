<section class="banner" id="banner">
    <div class="row p-a-0 m-a-0">
        <div class="col-lg-6">
            <p class="fbold f16 forange"><?= $this->lang->line('trumecs_is', FALSE) ?></p>
            <h5 class="fbold f40 fwhite"><?= $this->lang->line('trumecs_tagline', FALSE) ?></h5>
            <p class="f16 fwhite"><?= $this->lang->line('trumecs_description', FALSE) ?></p>
        </div>
    </div>
</section>
...
<div class="content-page d-flex flex-column gap-4 m-t-3" id="tentang">
    <section class="trumecs-why" id="trumecs-why">
        <div class="row">
            <div class="col-lg-6">
                <p class="fbold f38 p-a-0 m-a-0"><?= $this->lang->line('why_trumecs', FALSE) ?> <span class="forange"><?= $this->lang->line('must_trumecs', FALSE) ?></span> TRUMECS ?</p>
                            ...
                            <div class="col-lg-10">
                                <div class="card d-flex-sb d-flex-ai-center p-a-1">
                                    ...
                                    <div class="text m-l-1">
                                        ...
                                        <span class="f12" style="line-height: 10px;"><?= $this->lang->line('trumecs_secure_subtitle', FALSE) ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-10">
                                <div class="card d-flex-sb d-flex-ai-center p-a-1">
                                    ...
                                    <div class="text m-l-1">
                                        ...
                                        <span class="f12" style="line-height: 10px;"><?= $this->lang->line('trumecs_valid_subtitle', FALSE) ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-10">
                                <div class="card d-flex-sb d-flex-ai-center p-a-1">
                                    ...
                                    <div class="text m-l-1">
                                        ...
                                        <span class="f12"><?= $this->lang->line('trumecs_transparent_subtitle', FALSE) ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card p-a-1 card-service d-flex flex-column justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="<?php echo base_url() ?>public/icon/partner.png" alt="" style="width: 15%;">
                                    ...
                                    <a href="/principal/form" class="btn btnnew f14"><?= $this->lang->line('read_detail', FALSE) ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card p-a-1 card-service d-flex flex-column justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="<?php echo base_url() ?>public/icon/insurance.png" alt="" style="width: 15%;">
                                        <h6 class="fbold m-a-0 p-a-0">
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card p-a-1 card-service d-flex flex-column justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="<?php echo base_url() ?>public/icon/robot.png" alt="" style="width: 15%;">
                                        <h6 class="fbold m-a-0 p-a-0">
    ...
    <section class="brand d-flex flex-column gap-4" id="brand ">
        <div class="row justify-content-center d-flex">
            <div class="col-lg-4">
                <p class="fbold fwhite f24 text-center">BERBAGAI NAMA BESAR TELAH BERGABUNG</p>
            </div>
        </div>
        <div class="row p-x-3">
            <?php $in = 1;
    ...
    <section class="youdo m-t-3" id="youdo">
        <div class="row d-flex justify-content-between align-items-center">
            <div class="col-lg-5">
                <p class="fbold f38 p-a-0 m-a-0 title"><?= $this->lang->line('what_you_do_trumecs_title', FALSE) ?>
