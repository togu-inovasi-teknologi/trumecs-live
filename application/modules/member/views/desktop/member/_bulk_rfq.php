            ...
            <tr>
                <td class="container-fluid f12">
                                ...
                                <div class="row logo-trumecs d-flex flex-column">
                                    <p class="f22 fbold text-center">Permintaan Harga</p>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="d-flex-sb align-items-start m-b-2">
                                            <div class="d-flex flex-column gap-0">
                                                ...
                                                <p class="m-a-0 p-a-0">Hal : Permintaan Harga</p>
                                            </div>
                                            <p>Jakarta, <?php
                                        ...
                                        <div class="d-flex flex-column gap-0 m-b-2">
                                            ...
                                            <p class="m-a-0 p-a-0">Bapak/Ibu</p>
                                            <p class="m-a-0 p-a-0">Supplier</p>
                                        </div>
                                        <div class="d-flex flex-column gap-0 m-b-2">
                                            <p class="m-a-0 p-a-0">Dengan Hormat,</p>
                                            <p class="m-a-0 p-a-0">Mohon dikirimkan penawaran harga untuk kebutuhan item kami di bawah ini:</p>
                                        </div>
                                        <div class="d-flex flex-column gap-2 m-b-1">
                                            <table id="table-confirmation" class="table table-bordered table-striped table-sm" style="width:100%;" cellspacing="2">
                                                <thead>
                                                    <tr class="f12">
                                                        <th style="width:5%;" class="text-center">No.</th>
                                                        <th style="width:65%;" class="text-center">Nama Item</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($key["items"] as $keys) : ?>
                                                        <tr class="table-nego f12">
                                                            ...
                                                            <td style="width:65%;" class="va-center">
                                                                <?php echo $keys["items"] ?><br/>
                                                                <small><?php echo $keys["notes"] ?></small>
                                                            </td>
                                                            <td style="width:15%;" class="text-right va-center"><?php echo number_format($keys["qty"], 0, ",", "."); ?></td>
                                        ...
                                        <div class="d-flex flex-column gap-0 m-b-1">
                                            ...
                                            <?php echo nl2br($key['sourcing_notes']) ?>
                                        </div>
