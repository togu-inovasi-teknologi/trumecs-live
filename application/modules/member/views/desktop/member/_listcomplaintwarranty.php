<div class="row historypesanan">
	...
	<div class="col-md-6">
		<strong class="f22">Klaim Garansi</strong>
	</div>
	<div class="col-md-6 text-right">
		<a class="btn btn-orange" href="<?php echo base_url() ?>member/formwarranty">Ajukan Klaim Garansi</a>
	</div>
	<div class="col-md-12 ">
		<hr>
			...
			<tbody>
				<?php foreach ($list as $key) : ?>
					<tr>
						...
						<td>
							<?php if ($key["product"] != NULL) : ?>
								<a tabindex="1000" data-html="true" data-toggle="popover" data-trigger="focus" data-placement="bottom" title="Klaim Garansi" data-content="Produk:<br><?php echo $key["product"] ?><hr>Deskripsi:<br><?php echo $key["description"] ?>" class="label label-warning">baca</a>
						</td>
					<?php endif ?>
					</td>
					<td>
