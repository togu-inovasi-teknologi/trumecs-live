<div class="row historypesanan">
	...
	<div class="col-md-12">
		<strong class="f22">Form Klaim Return</strong>
		<hr>
	</div>
	<div class="col-md-12 ">
		<form class="formreturn" action="<?php echo base_url() ?>member/sentclaimreturn" method="POST">
			<div class="row ">
				<div class="col-md-3">
					Id Order*
				</div>
			...
			<div class="row ">
				...
				<div class="col-md-9">
					<div class="checkbox">
						<label><input type="checkbox" name="statement[]" value="Diterima dalam keadaan segel terbuka/rusak."><span>Diterima dalam keadaan segel terbuka/rusak.</span></label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" name="statement[]" value="Diterima dalam keadaan kemasan terbuka/rusak."><span>Diterima dalam keadaan kemasan terbuka/rusak.</span></label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" name="statement[]" value="Jumlah Sparepart yang diterima tidak sesuai dengan yang dipesan."><span>Jumlah Sparepart yang diterima tidak sesuai dengan yang dipesan.</span></label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" name="statement[]" value="Sparepart yang diterima rusak."><span>Sparepart yang diterima rusak.</span></label>
					</div>
				</div>
				<div class="clearfix "></div>
				<hr class="m-x-1">
			...
			<div class="row ">
				<div class="col-md-3">
					...
					<small><a tabindex="999" style="cursor:pointer" data-html="true" data-container="body" data-trigger="focus" data-toggle="popover" title="Bukti Penerimaan Barang" data-content="<img src='<?php echo base_url() ?>public/image/example-buktipengiriman.jpg'>"><i class="fa fa-question-circle forange"></i></a></small>
				</div>
			...
			<div class="row ">
				<div class="col-md-3">
					<?php if (count($listorder) > 0) : ?>
						<button class="btn btn-orange form-control proccessshow" modal-text="Klaim Anda sedang dikirim" type="submit">Kirim Klaim</button>
					<?php else : ?>
