	...
	<div class="row">
		...
		<div class="col-lg-12">
			<div class="card borderdesk p-a-1 m-t-1 f14">
				<div class="row">
					<div class="col-lg-12 ">
						<strong class="f18">Pesanan Saya</strong>
								...
								<?php if (count($listhistory) > 0) : ?>
									<?php foreach ($listhistory as $key) : ?>
										<tr>
											...
											<td><a class="label label-<?php echo ($key["status"] != "paid") ? ($key["status"] == "unpaid") ? "default" : "primary" : "success"; ?>"><?php echo $key["status"] ?></a></td>
