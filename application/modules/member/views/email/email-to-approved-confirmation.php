...
<div style="background-color:#fff;width:100%;padding:15px;font-family:sans-serif">
    ...
    <p>
        Konfirmasi untuk Id Order : <strong><?php echo $order_id ?></strong> telah disetujui.<br>
        Kami akan segera memproses pesanan Anda.<br>
        <br>
        Jika Anda akan membatalkan pesanan ini, Silahkan baca untuk ketentuan <a href="<?php echo base_url() ?>page/45/Ketentuan%20Berbelanja" target="_blank" style="color:orange;text-decoration:none">Pembatalan Transaksi</a>
</div>
