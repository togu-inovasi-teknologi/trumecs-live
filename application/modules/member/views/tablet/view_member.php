	...
	<div class="<?php if (!$this->agent->is_mobile()) : ?>row<?php endif ?>">
		...
		<div class="card col-xs-12 bordercard" style="background: linear-gradient(to bottom right, #FF6348, #FFA502);">
			<div class="card-body" style="padding: 20px; color:#fff;">
				<div class="row">
					<div class="col-xs-4">
						<img src="<?php echo base_url() ?>public/image/drum1.jpg" alt="Avatar" class="rounded-circle" width="75px">
					</div>
					<div class="col-xs-8">
						<h6 class="font-weight-bold f16">Muhammad Ramdhan</h6>
						<div class="row">
							<small class="pull-left label label-<?php echo $levelmember ?> p-x-1" style="padding:5px;text-transform:capitalize;color:#000"><?php echo $levelmember ?></small>
							<small class="pull-right">TRU Koin: <a href="<?php echo base_url() ?>member/saldo"><strong><?php echo number_format($pointmember, 0, ',', '.') ?></strong></a></small>
						</div>
			...
			<div class="col-xs-12 text-center" style="margin-bottom: -20px;">
				<div class="text-center">
					<button class="btn btnnew"><i class="fa fa-building"></i> Cek Toko <i class="fa fa-angle-right"></i></button>
				</div>
			</div>
		</div>
		...
		<?php endif ?>
		<div class="col-md-9 col-xs-12 content p-y-1" style="background:#fff;border-radius:5px;box-shadow:0px 3px 7px rgba(0,0,0,0.05);">
