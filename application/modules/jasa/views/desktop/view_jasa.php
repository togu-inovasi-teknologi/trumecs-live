            ...
            <div class="col-lg-12 header-banner">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-7 d-flex flex-column gap-3">
                        <div class="headline">
                            <h1 class="fbold f40"><?= $this->lang->line('tagline_service_tittle') ?></h1>
                ...
                <div class="row">
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            <h6 class="fbold m-b-1"><?= $this->lang->line('service_benefit_tittle_1') ?></h6>
                            <h6><?= $this->lang->line('service_benefit_subtitle_1') ?>
                            </h6>
                        </div>
                    </div>
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            <h6 class="fbold m-b-1"><?= $this->lang->line('service_benefit_tittle_2') ?></h6>
                            <h6><?= $this->lang->line('service_benefit_subtitle_2') ?>
                            </h6>
                        </div>
                    </div>
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            <h6 class="fbold m-b-1"><?= $this->lang->line('service_benefit_tittle_3') ?></h6>
                            <h6><?= $this->lang->line('service_benefit_subtitle_3') ?>
                            </h6>
                        </div>
                    </div>
                </div>
