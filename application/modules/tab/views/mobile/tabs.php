<ul class="nav nav-tabs nav-tabs-search d-flex" id="myTab" role="tablist">
    <li class="nav-item active" role="presentation">
        <button class="nav-link tab-search radius-none active p-y-sm f12" id="home-tab" data-toggle="tab"
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link tab-search radius-none p-y-sm f12" id="profile-tab" data-toggle="tab"
            data-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
            <img src="<?= base_url('public/icon/ic-search.svg') ?>" alt="">
            <?= $this->lang->line("search_product", FALSE) ?></button>
    </li>
    <li class="nav-item text-center" role="presentation">
        <a href="<?= base_url('bulk') ?>" class="nav-link bg-tru-primary radius-none p-y-sm f12" id="contact-tab">
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane border-sm fade show active p-x-sm p-y-sm in" id="home" role="tabpanel"
        ...
        <div class="row">
            ...
            <div class="col-xs-3 col-md-3" style="height: 100px">
                <a href="<?php echo base_url() ?>c/<?php echo $i["url"] ?>" style="text-decoration: none;">
                    <div class="text-center">
                        <img src="<?php echo base_url(); ?>public/image/category/card-<?php echo $i["url"]; ?>.png"
                            alt="<?php echo $i["name"]; ?>" width="100%">
                        <p class="fblack f8 m-t-1"><?php echo $i["name"]; ?></p>
                    </div>
                </a>
            </div>
            <?php endforeach ?>
