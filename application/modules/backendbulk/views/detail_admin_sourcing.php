<div class="container d-flex flex-column gap-3">
    <h2><a class="btn btn-black" href="<?php echo site_url('backendbulk/supplier'); ?>"><small><span class="fa fa-chevron-left"></span></small></a> Detail Sourcing</h2>
                    ...
                    <div class="card-body p-a-1">
                        <div class="row d-flex-sb">
                            ...
                            <div class="col-lg-6 d-flex flex-column gap-3">
                                ...
                                <?php if ($files != null || '') : ?>
                                    <div class="d-flex flex-column">
                                        <p class="m-a-0 f20">Daftar berkas:</p>
                                        <?php foreach ($files as $listFiles) : ?>
                                            <a href="<?php echo base_url('public/sourcing/' . $listFiles->filename); ?>"
                                                target="_blank"><?php echo $listFiles->filename ?></a>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endif; ?>
                ...
                <?php if ($items != null) : ?>
                    <div class="card-body p-a-1 table-responsive">
                        <table class="table table-sm table-bordered table-condensed table-item" style="max-width:none !important;width:1900px !important;">
                            <tr>
                                ...
                                <th class="text-center f12" width="300px">Harga Nego Supplier</th>
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <?php if ($listItems["price_nego"] != 0 && $listItems["price_nego"] != NULL && $listItems["status"] == 1): ?>
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn btn-success harga-fix"><i class="bi bi-check"></i></button>
                                            ...
                                            <?php else: ?>
                                                <span class="input-group-btn action-nego-cust">
                                                    <button type="button" class="btn btn-primary change-nego-cust"><i class="bi bi-pencil"></i></button>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <td class="text-right f12">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <span class="input-group-btn action-nego">
                                                <button type="button" class="btn btn-primary change-nego"><i class="bi bi-pencil"></i></button>
                                            </span>
                                        </div>
                                    </td>
                                    <td class="text-right f12">
                                        ...
                                        <div class="input-group input-group-sm text-center">
                                            <span class="input-group-btn">
                                                <?php if (($listItems["price_nego"] == 0 || $listItems["price_nego"] == NULL) && $listItems["status"] != 2): ?>
                                                    <button type="button" class="btn btnnewgreen harga-fix"><i class="bi bi-check"></i></button>
                                                    <!--<button type="button" class="btn btnnewred f10 harga-tolak"><i class="fa fa-times"></i></button>-->
                                                <?php else: ?>
                                                    <button type="button" disabled="disabled" class="btn btn-default disabled "><i class="bi bi-check"></i></button>
                                                <?php endif; ?>
                                            </span>
                                        </div>
                                    </td>
                    ...
                    <div class="d-flex-sb align-items-start">
                        ...
                        <div class="d-flex gap-1 m-a-0 action-nego">
                            <button class="btn btnnewgreen f8 harga-fix"><i class="bi bi-check"></i></button>
                    ...
                    <div class="card-body p-a-1">
                        <?php if ($detail->status != 3) : ?>
                            <button type="submit" class="btn btn-secondary btn-sm pull-right"><i class="bi bi-check-circle"></i> Simpan</button>
                            <!--<button type="button" class="btn btn-sm btn-secondary pull-right m-r-2"><i class="fa fa-copy"></i> Buat RFQ</button>
                    <button type="button" class="btn btn-sm btn-secondary pull-right m-r-1"><i class="fa fa-file"></i> Cetak SPH</button>-->
            ...
            <div class="card">
                ...
                <div class="card-body p-a-1">
                    <form class="form-horizontal" action="<?php echo site_url('backendbulk/send_item/' . $detail->id); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-secondary btn-sm pull-right" type="submit"><i class="bi bi-check-circle"></i> Simpan</button>
                        <div class="clearfix"></div>
                    </form>
                </div>
            </div>
                ...
                <div class="card-body p-a-1">
                    ...
                    <form class="row" method="POST" action="<?php echo site_url('backendbulk/add_files/' . $detail->id); ?>" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12 text-right">
                            <button type="submit" class="btn btn-secondary btn-sm"><i class="bi bi-check-circle"></i> Simpan</button>
                        </div>
                    </form>
                    <div class="clearfix"></div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-a-1">
                    <form class="form-horizontal" action="<?php echo site_url('backendbulk/send_item/' . $detail->id); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <textarea class="form-control" name="admin_note" placeholder="Berikan catatan untuk member"></textarea>
                        <label for="">Catatan Internal:</label>
                        <textarea class="form-control" name="internal_notes" placeholder="Berikan catatan untuk member"><?php echo $detail->internal_notes ?></textarea>
