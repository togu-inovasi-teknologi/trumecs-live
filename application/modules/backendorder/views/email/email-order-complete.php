...
<div style="background-color:#fff;width:100%;padding:15px;font-family:sans-serif">
	...
	<p>
    Terimakasih,<br>
    Pesanan dengan Id Order : <strong><?php echo $order_id ?></strong> telah selesai.<br>
    Kami mengharapkan Anda berbagi cerita pengalaman berbelanja dengan trumecs.com dengan mengisi <a href="<?php echo base_url() ?>member/testimonialform" target="_blank" style="color:orange;text-decoration:none">Testimonial</a>
