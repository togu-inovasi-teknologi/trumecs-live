...
<div class="listproduct row" itemtype="http://schema.org/ItemList">
    ...
    <?php if (!empty($listproduct)) { ?>
        <?php foreach ($listproduct as $key) : ?>
            <div itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product" class="col-lg-3 produk-promo">
                <div class="card card-shadow">
                    <div class="row">
                        <a itemprop="url" href="<?php echo base_url() ?>product/<?php echo $key["id"] ?>/<?php echo preg_replace("/[^a-zA-Z0-9]/", "-", ucwords(strtolower($key["tittle"]))) ?>">
                            ...
                            ?>
                            <div class="col-lg-12">
                                <img src="<?php echo base_url() ?>public/image/product/<?php echo ($ext == ".jpg") ? $key["img"] : "../noimage.png"; ?>" alt="<?php echo $key["tittle"]; ?>" style="width: 100%;">
                                <?php echo $img_promo; ?>
                            </div>
