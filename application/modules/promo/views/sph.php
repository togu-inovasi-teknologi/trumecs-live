...
<html><head>
        ...
        <style>
            ...
            .c-select, .progress[value], button.close {
        ...
        <div class="container">
            ...
            <div class="row text-center" style="margin-top:30px">
                <h1 style="text-align:center;font-weight:bold">Offer Letter</h1>
            </div>
                ...
                <div class="col-xs-12">
                    <table width="100%">
                        <tr>
                            ...
                            <td style="width:300px">: <?php echo $data['number'] ?></td>
                            <td style="text-align:right">Jakarta, <?php echo date("d M Y") ?></td>
                        </tr>
                        <tr>
                            <td style="width:100px">Subject</td>
                            <td style="width:300px">: Penawaran harga khusus Pertamina</td>
                        ...
                        <tr>
                            ...
                            <td style="width:300px">: <?php echo $data['name'] ?></td>
                            <td style="text-align:right"></td>
                        </tr>
                        <tr>
                            <td style="width:100px"></td>
                            <td style="width:300px">&nbsp; <?php echo $data['company'] ?></td>
                            <td style="text-align:right"></td>
                        </tr>
                        <tr>
                            <td style="width:100px"></td>
                            <td style="width:300px">&nbsp; di <?php echo $data['location'] ?></td>
                            <td style="text-align:right"></td>
                        </tr>
                        <tr>
                            <td style="width:100px"></td>
                            <td style="width:300px">&nbsp; <?php echo $data['phone'] ?></td>
                            <td style="text-align:right"></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row" style="margin-top:50px">
                <div class="col-xs-12">
                    Dengan hormat, <br />
                    Bersama ini kami kirimkan daftar harga pelumas merek Pertamina harga khusus pelanggan baru
                </div>
            </div>
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tr>
                            ...
                            <th style="text-align:center">Harga Setelah Pajak</th>
                        </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td style="text-align:center">1</td>
                                <td>Meditran SX Plus 15W-40 CI-4</td>
                                <td style="text-align:center">1</td>
                                <td style="text-align:center">Drum (200L)</td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '5,704,633':'5,650,043' ?></td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '6,332,143':'6,271,548' ?></td>
                            </tr>
                            <tr>
                                <td style="text-align:center">2</td>
                                <td>Meditran SX 15W-40 CH-4</td>
                                <td style="text-align:center">1</td>
                                <td style="text-align:center">Drum (209L)</td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '5,748,883':'5,693,869' ?></td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '6,381,260':'6,320,195' ?></td>
                            </tr>
                            <tr>
                                <td style="text-align:center">3</td>
                                <td>Meditran S 40 CF/SF-2</td>
                                <td style="text-align:center">1</td>
                                <td style="text-align:center">Drum (209L)</td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '5,424,854':'5,372,942' ?></td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '6,021,588':'5,963,965' ?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:center">1</td>
                                <td style="text-align:center">Drum (209L)</td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '5,133,093':'5,083,973' ?></td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '5,697,734':'5,643,210' ?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:center">1</td>
                                <td style="text-align:center">Drum (209L)</td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '5,228,984':'5,178,945' ?></td>
                                <td style="text-align:right">Rp <?php echo $data['type'] == 'nc' ? '5,804,172':'5,748,629' ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="row" style="margin-top:20px">
                <div class="col-xs-12">
                    Catatan:
                    <ol>
                        <li>Transaksi menggunakan PPN 11%</li>
                        <li>Harga tidak termasuk biaya pengiriman</li>
                        <li>Pembayaran CBD (Cash Before Delivery)</li>
                        <li>Stok berjalan</li>
                        <?php if($data['type'] == 'cirebon'): ?>
                        <li>Penawaran ini hanya berlaku bagi pelanggan yang berada di: Cirebon, Kuningan, Bandung, Indramayu, Brebes, Tegal, Majalengka, Palimanan</li>
                        <?php endif; ?>
                    </ol>
                </div>
            </div>
