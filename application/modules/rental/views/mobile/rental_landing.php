            ...
            <div class="col-lg-12 header-banner m-t-3">
                <div class="row p-y-3">
                    <div class="col-xs-12 d-flex flex-column gap-3">
                        <div class="headline">
                            <p class="fbold f20">Raih Pelanggan Baru, Sertakan Layanan Rental Alat Berat Anda di Sini!
                            </p>
                ...
                <div class="row">
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            <p class="fbold m-b-1">Promosi Efektif</p>
                            <p class="f12">Dukungan pemasaran dari platform kami membantu menyebarkan informasi tentang
                                layanan
                    ...
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            ...
                            <p class="f12">Sistem pembayaran yang aman dan terpercaya memberikan jaminan keamanan
                                transaksi bagi
                    ...
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            <p class="fbold m-b-1">Dukungan Pelanggan 24/7</p>
                            <p class="f12">Tim dukungan pelanggan yang siap membantu penyedia jasa rental dalam
                                menanggapi
