<section class="header" id="header">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 header-banner p-y-3">
                <div class="row d-flex align-items-center p-y-3">
                    <div class="col-lg-7 d-flex flex-column gap-3">
                        <div class="headline">
                            <h1 class="fbold f40">Raih Pelanggan Baru, Sertakan Layanan Rental Alat Berat Anda di Sini!
                            </h1>
                            <p class="color-dark-grey">Bangun Jejak Sukses, Bergabunglah dengan Komunitas Rental Alat
                                Berat Kami!</p>
                        </div>
                        <div class="form-email">

                            <a href="#campign-seller" class="btn btnnew m-y-1">Bergabung Sekarang</a>

                        </div>
                    </div>
                    <div class="col-lg-5 d-flex justify-content-end">
                        <img src=" <?php echo base_url(); ?>public/icon/rental-landing-icon.svg" alt="landing-service"
                            style="width:100%;">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            <h6 class="fbold m-b-1">Promosi Efektif</h6>
                            <h6>Dukungan pemasaran dari platform kami membantu menyebarkan informasi tentang layanan
                                rental, menjangkau target audiens dengan lebih efektif
                            </h6>
                        </div>
                    </div>
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            ...
                            <h6>Sistem pembayaran yang aman dan terpercaya memberikan jaminan keamanan transaksi bagi
                                penyedia jasa rental dan pelanggan
                            </h6>
                        </div>
                    </div>
                    <div class="col-lg-4 text-center">
                        <div class="card p-a-1 p-t-3" style="height: 200px">
                            <h6 class="fbold m-b-1">Dukungan Pelanggan 24/7</h6>
                            <h6>Tim dukungan pelanggan yang siap membantu penyedia jasa rental dalam menanggapi
                                pertanyaan atau mengatasi masalah yang mungkin timbul
                            </h6>
                        </div>
                    </div>
                </div>
