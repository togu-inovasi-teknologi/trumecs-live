					...
					<?php if (!empty($listfilter)): ?>
						<?php foreach ($listfilter as $key): ?>
							<tr>
								...
								<td>
									<a href="<?php echo base_url() ?>backendtestimonial/<?php echo ($key["moderate"] == "sudah") ? "update?id=" . $key["id"] . "&status=no" : "update?id=" . $key["id"] . "&status=sudah"; ?>" class="label label-<?php echo ($key["moderate"] == "sudah") ? "success" : "danger"; ?>">
