...
<div class="container">
    <div class="row d-flex m-y-2">
        <div class="col-lg-6">
            <a href="<?php echo base_url() ?>article/<?php echo $data_page_main[0]['url'] ?>"><?php echo $this->load->view('desktop/_main_article_large', ['article' => $data_page_main[0], 'img_base_url' => 'http://trumecs.com/']) ?></a>
        </div>
        <div class="col-lg-6">
...
<section class="tabsearch" id="tabsearch">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="fbold">Kirim Permintaan Barang Di Trumecs Lebih Mudah dan Cepat</h4>
            </div>
            <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row d-flex flex-column gap-2" id="article-list">
                    <?php foreach ($data_page as $artikel) : ?>
                        ...
                        <a href="<?php echo base_url() ?>article/<?php echo $artikel['url'] ?>" class="color-black"><?= $this->load->view('_article_row', ['artikel' => $artikel, 'img_base_url' => 'http://trumecs.com/']) ?></a>
                    <?php endforeach ?>
                </div>
            ...
            <div class="col-lg-4 sticky-member">
                <div class="row trend-article" id="trend-article">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="row d-flex flex-column gap-3 p-a-1">
                                <div class="col-lg-12">
                                    <p class="f20 fbold"><?= $this->lang->line('label_trending'); ?></p>
                                </div>
                                <?php foreach ($dataTrendingNews as $article) : ?>
                                    <a href="<?php echo base_url() ?>article/<?php echo $article['url'] ?>" class="color-black"><?= $this->load->view('_article_row_small', ['artikel' => $article, 'img_base_url' => 'http://trumecs.com/']) ?></a>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
