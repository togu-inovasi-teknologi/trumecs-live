        ...
        <div class="col-lg-3 p-a-0">
            <a href="<?php echo base_url() ?>article/<?php echo $key["url"] ?>">
                <div class="text-center">
                    <img class="img-center-product" style="object-fit: cover;width:100%;height:150px" src="<?php echo base_url() ?>timthumb?h=200&src=<?php echo base_url() ?>public/image/artikel/<?php echo $key["img"]; ?>">
                </div>
            </a>
        </div>
        <?php $str = str_split($key['title'], 100) ?>
        <div class="col-lg-9" style="line-height: 30px;">
            <small><?php echo $this->dateformat->indonesia($key["date"]); ?></small>
            <h4 class="fbold article-title" style="display: flex; height:auto; line-height:1.2em;"><a href="<?php echo base_url() ?>article/<?php echo $key["url"] ?>"><?php echo count($str) > 1 ? $str[0] . "..." : $str[0] ?></a></h4>
