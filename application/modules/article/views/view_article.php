...
<div id="article_page">
	<div class="row">
		...
		<div class="row nopt p-l-1" >
			<div class="col-lg-8 p-x-0">
				<div style="background:#fff;box-shadow:0px 3px 7px rgba(0,0,0,0.05);overflow:hidden;border-radius:5px" class="content-artikel col-xs-12" itemscope itemtype="http://schema.org/Article">
					...
					<div class="row " itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
						...
						<img alt="<?php echo $key["title"]; ?>" title="<?php echo $key["title"]; ?> - trumecs" class="img-responsive" src="<?php echo base_url() ?>timthumb?h=600&src=<?php echo base_url() ?>public/image/artikel/<?php echo $key["img"]; ?>">
					</div>
					<h1 class=" p-x-3 m-t-3 m-b-3 fbold"  itemprop="headline"><?php echo $key["title"]; ?></h1>
					<div class="p-x-3">
						<hr class="nomt nomb">
						<div class="col-lg-6 info-artikel p-x-0">
						...
						<div class="col-lg-6 share text-right hidden-sm hidden-xs p-x-0">
					...
					<div class="content-artikel-text p-x-3 p-y-1 f18">
						<?php if ($this->agent->is_mobile()): ?>
						 <div class="col-lg-4 col-md-6 col-sm-7 col-xs-7" style="float: right;">
						...
						foreach($paragraph as $value):
						    ...
						    if($i%2 == 0 && $length >= 200){
						        echo '<div class="clearfix"></div><div class="col-xs-12 p-a-0 m-t-2 m-b-2"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8875911463210576"
				...
				<div class="clearfix"></div>
				<h4 class="fbold m-t-3 m-b-1"><?php echo $this->lang->line('artikel_terkait'); ?></h4>
				<?php echo $this->load->view('article/_same_article', array('article'=>$sameartikel, 'media'=>'half')); ?>
				
			</div>
			<div class="col-lg-4">
				<h5 class=""><?php echo $this->lang->line('artikel_terbaru'); ?></h5>
				<?php echo $this->load->view('article/_same_article', array('article'=>$newartikel, 'media'=>null)); ?>
				
				<div class="card p-b-1 promo">
	        		<?php $promo_inseach_ver ? $this->load->view("_promovertical") : ""; ?>
				</div>
			</div>
		</div>
	</div>
