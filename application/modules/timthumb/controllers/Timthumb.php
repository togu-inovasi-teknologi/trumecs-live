...
if (! defined('FILE_CACHE_DIRECTORY')) 		define('FILE_CACHE_DIRECTORY', './public/image/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if (! defined('DEFAULT_S'))					define('DEFAULT_S', 3);								// Default sharpen value. Allows overrid in timthumb-config.php
...
class timthumb
{
	...
	protected function serveErrors()
	{
		...
		$html .= '</ul>';
		echo '<img src="http://localhost/trumecs-hmvc/public/image/logonew.png" width="100px"><br>Sorry:' . $html . '<br />';
	}
