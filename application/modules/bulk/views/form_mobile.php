...
<div id="page_detail">
	<div class="row m-t-2">
        ...
        <div class="clearfix"></div>
        <div class="col-lg-12">
            <h2 class="fbold text-center p-a-3" style="font-size:40px">Cara Baru Berbelanja</h2>
            <div class="col-xs-12 p-a-3 text-center m-b-1"  style="background:#fff;box-shadow:0px 3px 7px rgba(0,0,0,0.05);overflow:hidden;border-radius:5px">
            ...
            <div class="col-xs-12 p-a-3 text-center"  style="background:#fff;box-shadow:0px 3px 7px rgba(0,0,0,0.05);overflow:hidden;border-radius:5px">
