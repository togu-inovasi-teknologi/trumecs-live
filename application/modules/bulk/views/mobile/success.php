<div class="col-xs-12">
    ...
    <div class="card p-a-1 text-center">
        ...
        <br />
        <p>Data anda sudah kami terima dan akan segera kami review.<br>Tim kami akan menghubungi anda dalam waktu 2 x 24 jam.</p>
    </div>
    <a class="btn btnnew btn-block" href="<?php echo site_url('/member/bulk'); ?>">Kembali</a>
</div>