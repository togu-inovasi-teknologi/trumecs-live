                                    ...
                                    <div id="template">
                                        ...
                                        <div class="file-upload">
                                            <div class="col-lg-6 px-0">
                                                <span class="name name-file m-0" data-dz-name></span>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="progress progress-striped active m-0" role="progressbar"
                                                    aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
                                                    <div class="progress-bar progress-bar-success m-0"
                                            ...
                                            <div class="col-lg-2 d-flex justify-content-between align-items-center px-0">
                                                ...
                                                <i data-dz-remove class="bi bi-trash text-danger pointer m-0"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
