<div class="row m-t-3">
    <div class="col-xs-12">
        <h1 class="text-center fbold"><?php echo $this->lang->line('judul_halaman_partnership') ?></h1>
    </div>
</div>
<div class="row">
    <div class="listproduct m-t-3 text-center ">
        <div class="col-xs-12">
            <div class="card p-a-2">
                ...
                <a href="<?php echo base_url('principal/form') ?>" class="btn btn-lg btn-orange text-center row principal-button"><strong><?php echo $this->lang->line('tombol_principal') ?></strong></a>
            </div>
        </div>
        <div class="col-xs-12">
            <div class="card p-a-2">
                ...
                <a href="<?php echo base_url('agent/form') ?>" class="row btn btn-lg btn-orange text-center agent-button"><strong>D<?php echo $this->lang->line('tombol_agen') ?></strong></a>
            </div>
        </div>
    </div>
</div>
