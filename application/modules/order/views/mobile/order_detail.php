<div class="row">
    ...
    <?= ($this->session->flashdata('error_uploaded_po') == "") ? "" :
        '<div class="col-xs-12"><div class="alert alert-danger f8 text-center fbold m-b-0">' .
        $this->session->flashdata('error_uploaded_po') .
        '</div></div>'; ?>
    <div class="col-lg-12 title-mobile d-flex-ai-center gap-2 m-y-1">
        <a href="<?php echo base_url() ?>member/confirmation_list"><i class="fa fa-arrow-left forange"></i></a>
        <p class="title-content m-a-0">Daftar Pesanan</p>
    </div>
