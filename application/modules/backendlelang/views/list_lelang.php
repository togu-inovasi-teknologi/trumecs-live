							...
							<tr>
								...
								<td>
									<a class="label label-warning"
										href="<?php echo base_url() ?>backendlelang/form?id=<?php echo $key["id"] ?>"><i class="bi bi-pencil"></i></a>
								</td>
								<td>
									<a class="label label-primary"
										href="<?php echo base_url() ?>backendlelang/galery?id=<?php echo $key["id"] ?>"><i class="bi bi-image"></i></a>
								</td>
								<td>
									<a class="label click label-danger"
										onclick="hapus(<?php echo $key["id"] ?>,'<?php echo $key["tittle"] ?>')"
										url="<?php echo base_url() ?>backendlelang/hapus?id=<?php echo $key["id"] ?>"><i class="bi bi-trash"></i></a>
								</td>
							</tr>
						<?php endforeach ?>
					<?php else: ?>
